...
import (
	...
	"cs.utexas.edu/zjia/faas-void/utils"
...
func buildNoopRequest() utils.JSONValue {
...
func main() {
	...
	for {
		...
		client.AddJsonFnCall(FLAGS_fn_prefix+"VoidNoop", buildNoopRequest())
	}
	...
	printFnResult("VoidNoop", elapsed, results)
}
